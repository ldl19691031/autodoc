...
import { makeChain } from './createLearningChain.js';
...
export const learn = async (
    ...
    const { question } = await inquirer.prompt([
      {
        type: 'input',
        name: 'question',
        message: chalk.yellow(`\nWhat's your next learning topic?\n`),
      },
    ]);
  ...
  let question = `Please explain the top level concept of this project to help me understand this project.`;//await getQuestion();
